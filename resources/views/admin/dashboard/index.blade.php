        ...
        <div class="row arvo-font">
            <div class="col-12 col-sm-6 col-md-6">
                <div class="card bg-info text-white" style=" color: white;">
                    <div class="card-body">
                        <h5 class="card-title"><b>TOTAL COMM:</b></h5>
                        <br>
                        <br>
                        <h2> {{number_format((Auth::user()->wallet->commission),2,".",",")}} </h2>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-6">
                <div class="card bg-success text-white" style="color: white;">
                    <div class="card-body">
                        <h5 class="card-title"><b>COMMISSION PERCENTAGE: <strong class="text-danger text-lg"></strong></b></h5>
                        <br>
                        <br>
                        <h2 class="text-danger text-bold">{{Auth::user()->commission}}%</h2>
                    </div>
                </div>
            </div>
