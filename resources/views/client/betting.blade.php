...
<style>
    ...
    .content-wrapper{
        background-image: url("{{asset('images/bg-ppc.png')}}");
...
<div class="container-fluid">
    <div class="row remove-side-margins">
        ...
        <div class="col-md-6">
            @if (Auth::user()->wallet->balance >= 0 || $myBetMeron > 0 || $myBetWala > 0 || Auth::id() == 10)
                <div class="card mb-1">
                    <div class="card-body pb-0">
                        ...
                        <div class="row" style="margin-top: -1px;">
                            <div class="col text-center text-white font-weight-bolder rowcol-border" id="fight-status">
                                @if($event)
                                    <span class="statusChange">{{removeUnderscore($fight->status)}}</span>
                                @else
                        ...
                        <div class="row betting mb-2 mt-2">
                            <div class="col-6 text-center border col-6-override mb-1 pb-1">
                                ...
                                <div class="winnings meron-wins text-18 mb-3">
                                    {{number_format($myBetMeron*$timer->value,0,".",",")}}
                                </div>
                            ...
                            <div class="col-6 text-center border col-6-override ml-10 mb-1 pb-1">
                                ...
                                <div class="winnings wala-wins text-18 mb-3">{{number_format($myBetWala*$timer->value,2,".",",")}}</div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('images/rules/rules.jpg') }}" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('images/rules/promo.jpg') }}" alt="Second slide">
                          </div>
                        </div>
...
<script>
    ...
    var betMeron = "{{ str_replace(',', '', $betMeron)}}";
    var betWala = "{{ str_replace(',', '', $betWala)}}";
    var betDraw = "{{ str_replace(',', '', $betDraw)}}";
    var percentWala = "{{$odds['wala']}}";
    var percentMeron = "{{$odds['meron']}}";
    var results = {!!$wins!!};
    var myBetWala = "{{$myBetWala}}"
    var myBetMeron = "{{$myBetMeron}}"
    var myBetDraw = "{{$myBetDraw}}"
    var eventIDString = "{{$event->event_id}}";
    var maxRow = 8;
    var multiplier = "{{$timer->value}}";
    @endif
