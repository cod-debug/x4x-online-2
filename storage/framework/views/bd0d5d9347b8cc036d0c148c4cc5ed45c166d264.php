                            ...
                            <div class="col-md-8 col-12">
                                <span class="" style="background-color: transparent;border: none;">
                                    ...
                                    <span class="pl-0 text-18 text-warning font-weight-bold wallet-balance border-0 bg-black" style="color:#ffc107!important;">
                                        <?php echo e(number_format(bcdiv(Auth::user()->wallet->balance, 1, 2) , 2, '.', ',')); ?>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\swcslasher\resources\views/client/betting.blade.php ENDPATH**/ ?>