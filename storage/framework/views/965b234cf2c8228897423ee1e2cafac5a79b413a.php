<div class="modal fade" id="commissionPercentModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="<?php echo e(route('set.commission')); ?>" method="POST">
...
<?php /**PATH /home/u428933156/domains/swcslasher.online/public_html/dmiphonl_source/resources/views/partials/modals/_setCommissionPercent.blade.php ENDPATH**/ ?>