    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('summary')); ?>" class="nav-link">
                        <i class="nav-icon fas fa-chart-area"></i>
                        <p>Summary Report</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('load.logs')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('commission.logs')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('withdraw.logs')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('deleted.accounts')); ?>" class="nav-link">
...
<?php /**PATH /home/u428933156/domains/swcslasher.online/public_html/dmiphonl_source/resources/views/partials/menus/_master-agent.blade.php ENDPATH**/ ?>