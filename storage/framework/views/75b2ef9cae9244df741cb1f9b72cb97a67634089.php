        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong><i class="fas fa-bars"></i> List of SUB OPERATORS</strong>
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                  <button class="btn btn-success" id="btn-search" data-url="<?php echo e(route('sub.operators')); ?>" type="button">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428933156/domains/swcslasher.online/public_html/dmiphonl_source/resources/views/admin/sub-operators/index.blade.php ENDPATH**/ ?>