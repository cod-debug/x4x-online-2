        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?php echo e(route('create.silver')); ?>" class="btn btn-success float-right">CREATE</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div><?php echo e(ucwords($op->name)); ?></div>
                                        <div class="fs-small"><?php echo e($op->contact_number); ?></div>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428933156/domains/swcslasher.online/public_html/dmiphonl_source/resources/views/admin/silver-agents/index.blade.php ENDPATH**/ ?>